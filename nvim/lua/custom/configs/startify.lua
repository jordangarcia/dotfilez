...
local section = {
  ...
  new_button = {
    ...
    val = {
      { type = "padding", val = 1 },
      { type = "text", val = "New...", opts = { hl = "SpecialComment", shrink_margin = false } },
      { type = "padding", val = 1 },
  ...
  session_list = {
    ...
    val = {
      { type = "padding", val = 1 },
      { type = "text", val = "Sessions", opts = { hl = "Type" } },
      { type = "padding", val = 1 },
      {
        type = "group",
        val = session_buttons { "gamma", "server", "client", "dotfilez" },
      },
    },
  },
  mru = {
