...
function M.setup(colors, config)
  ...
  return {
    ...
    Title = { fg = theme.ui.title, bold = true },
    ...
    WinBar = { fg = theme.ui.fg, bg = theme.ui.bg_gutter },
    WinBarPath = { fg = colors.palette.sumiInk6, bg = theme.ui.bg_gutter },
